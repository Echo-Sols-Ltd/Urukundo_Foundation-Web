            ...
            <div className="bg-white rounded-lg border border-gray-200 p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-600 text-sm font-semibold">
                      RWF
                    </span>
                    <input
                      type="number"
                ...
                <div>
                  ...
                  <div className="flex space-x-4">
                    <button
                      type="button"
                      onClick={() =>
                        handleInputChange('donationType', 'one-time')
                      }
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        handleInputChange('donationType', 'monthly')
                      }
                      className={`flex-1 py-3 px-4 rounded-lg border font-medium transition-colors ${
