      ...
      <div className="flex items-center justify-center py-16 px-4">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-black mb-4">Donation interests</label>
              <div className="space-y-3">
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    checked={formData.donationInterests.education}
                    onChange={(e) => handleInterestChange("education", e.target.checked)}
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) => handleInterestChange("health", e.target.checked)}
                    className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                  />
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) => handleInterestChange("artsAndCulture", e.target.checked)}
                    className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                  />
                  <span className="ml-3 text-sm text-gray-700">Arts & Culture</span>
                </label>
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) => handleInterestChange("environment", e.target.checked)}
                    className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                  />
                  <span className="ml-3 text-sm text-gray-700">Environment</span>
                </label>
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) => handleInterestChange("animalWelfare", e.target.checked)}
                    className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                  />
                  <span className="ml-3 text-sm text-gray-700">Animal welfare</span>
                </label>
              </div>
            </div>
